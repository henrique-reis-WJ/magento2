...
return [
    'modules' => [
        ...
        'Webjump_ConfigAutomotivoHomepage' => 1,
        'Webjump_ConfigBannerBlockAutomotive' => 1,
        'Webjump_ConfigBannerBlockAutomotiveUs' => 1,
        'Webjump_ConfigCarbono' => 1,
        'Webjump_ConfigCarouselBlockAutomotive' => 1,
        'Webjump_ConfigCarouselBlockAutomotiveUs' => 1,
        'Webjump_ConfigCartPriceRules' => 1,
        'Webjump_ConfigCategory' => 1,
        'Webjump_ConfigCategoryAttributes' => 1,
        'Webjump_ConfigFestasHomePage' => 1,
        'Webjump_ConfigGridBlockAutomotive' => 1,
        'Webjump_ConfigGridBlockAutomotiveUs' => 1,
        'Webjump_ConfigLocaleAndLanguage' => 1,
        'Webjump_ConfigNativePayment' => 1,
        'Webjump_ConfigNativeShipping' => 1,
        'Webjump_ConfigThemeAutomotive' => 1,
        'Webjump_ConfigThemeParty' => 1,
        'Webjump_CoreConfigurator' => 1,
        'Webjump_CreateAttributeSets' => 1,
        'Webjump_CreateBannerBlockParty' => 1,
        'Webjump_CreateBannerBlockPartyUS' => 1,
        'Webjump_CreateCarouselBlockParty' => 1,
        'Webjump_CreateCarouselBlockPartyUS' => 1,
        'Webjump_CreateFooterLinksAutomotive' => 1,
        'Webjump_CreateFooterLinksAutomotiveUs' => 1,
        'Webjump_CreateFooterLinksParty' => 1,
        'Webjump_CreateFooterLinksPartyUS' => 1,
        'Webjump_CreateFooterSocialLinksAutomotive' => 1,
        'Webjump_CreateFooterSocialLinksAutomotiveUs' => 1,
        'Webjump_CreateFooterSocialLinksParty' => 1,
        'Webjump_CreateFooterSocialLinksPartyUS' => 1,
        'Webjump_CreateGridBlockParty' => 1,
        'Webjump_CreateGridBlockPartyUS' => 1,
