...
class SetZAutomotivoDefaultCms implements DataPatchInterface
{
...
public function apply()
{
    ...
    $this->setDefaultCmsPage("automotivo_store_view_pt", "automotivobr");
    $this->setDefaultCmsPage("automotive_store_view_us", "automotivous");
