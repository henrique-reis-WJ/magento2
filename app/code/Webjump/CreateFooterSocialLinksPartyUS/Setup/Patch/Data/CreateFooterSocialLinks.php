...
namespace Webjump\CreateFooterSocialLinksPartyUS\Setup\Patch\Data;
...
class CreateFooterSocialLinks implements DataPatchInterface, PatchRevertableInterface
{
    ...
    public const IDENTIFIER_BLOCK = 'footer-social-links-party-us';
    /**
    ...
    protected function createFooterSocialLinks()
    {
        ...
        $cmsBlockData = [
            'is_active' => 1,
            'title' => 'Footer Social Links US - Party',
            'identifier' => self::IDENTIFIER_BLOCK,
            'stores' => [5],
            'content' => '<div data-content-type="html" data-appearance="default" data-element="main">&lt;div class="footer__social-image"&gt;
            &lt;img src="{{media url=wysiwyg/logo.png}}" alt="logo" /&gt;      
 &lt;/div&gt;
 &lt;div class="footer__social-links"&gt;  
             ...
             &lt;li&gt;&lt;a href="#"&gt;&lt;img src="{{media url=wysiwyg/youtube.png}}" alt="youtube" /&gt;&lt;/a&gt;&lt;/li&gt;     
             &lt;/ul&gt;
 &lt;/div&gt;
 </div>'
        ];
