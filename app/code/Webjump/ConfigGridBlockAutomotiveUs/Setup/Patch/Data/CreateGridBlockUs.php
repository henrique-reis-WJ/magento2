...
namespace Webjump\ConfigGridBlockAutomotiveUs\Setup\Patch\Data;
...
class CreateGridBlockUs implements DataPatchInterface, PatchRevertableInterface
{
    ...
    public const IDENTIFIER_BLOCK = 'grid-theme-automotive-us';
    ...
    public function apply()
    {
        ...
        $this->createGridBlockUs("automotive_store_view_us");
        $this->moduleDataSetup->getConnection()->endSetup();
    }
    /**
     *  Method to create cms landing page
     */
    protected function createGridBlockUs(string $storeCode)
    {
        ...
        $cmsBlockData = [
            'is_active' => 1,
            'title' => 'Grid Theme Automotive US',
