...
namespace Webjump\ConfigBannerBlockAutomotiveUs\Setup\Patch\Data;
...
class CreateBannerBlockUs implements DataPatchInterface, PatchRevertableInterface
{
    ...
    public const IDENTIFIER_BLOCK = 'banner-theme-automotive-us';
    ...
    public function apply()
    {
        ...
        $this->createBannerBlockUs("automotive_store_view_us");
        $this->moduleDataSetup->getConnection()->endSetup();
    }
    /**
     *  Method to create cms landing page
     */
    protected function createBannerBlockUs(string $storeCode)
    {
        ...
        $cmsBlockData = [
            'is_active' => 1,
            'title' => 'Banner Theme Automotive US',
