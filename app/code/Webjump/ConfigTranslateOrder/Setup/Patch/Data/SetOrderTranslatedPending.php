...
class SetOrderTranslatedPending implements DataPatchInterface
{
    ...
    private function getStoreLabels(): array
    {
        ...
        return [
         $storeViewFestasId => "Pending", // Here we define Status Label
         $storeViewAutomotivoId => "Pending" // Here we define Status Label
        ];
    }
