...
class SetOrderTranslatedPaymentReview implements DataPatchInterface
{
    ...
    private function getStoreLabels(): array
    {
        ...
        return [
         $storeViewFestasId => "Payment Review", // Here we define Status Label
         $storeViewAutomotivoId => "Payment Review" // Here we define Status Label
        ];
    }
