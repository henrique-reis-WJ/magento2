...
class SetOrderTranslatedComplete implements DataPatchInterface
{
    ...
    $storeViewAutomotivoId = $this->storeManager
      ...
      return [
         $storeViewFestasId => "Complete", // Here we define Status Label
         $storeViewAutomotivoId => "Complete" // Here we define Status Label
      ];
    }
