...
class SetOrderTranslatedProcessing implements DataPatchInterface
{
    ...
    private function getStoreLabels(): array
    {
        ...
        return [
         $storeViewFestasId => "Processing", // Here we define Status Label
         $storeViewAutomotivoId => "Processing" // Here we define Status Label
        ];
    }
